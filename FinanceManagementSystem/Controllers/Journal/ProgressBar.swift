...
class ProgressBar: UIView {
    ...
    @IBInspectable public lazy var backgroundCircleColor: UIColor = UIColor(red: 255/255, green: 255/255, blue: 255/255, alpha: 0.15)
    @IBInspectable public lazy var foregroundCircleColor: UIColor = UIColor.white
    @IBInspectable public lazy var startGradientColor: UIColor = UIColor.white
    @IBInspectable public lazy var endGradientColor: UIColor = UIColor.white
    ...
    override func draw(_ rect: CGRect) {
        ...
        let lineWidth = min(frame.size.width, frame.size.height) * 0.07
    ...
    private func createTextLayer(textColor: UIColor) -> CATextLayer {
        ...
        let fontSize = min(width, height) / 3 - 5
